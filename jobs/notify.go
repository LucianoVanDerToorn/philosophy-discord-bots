...
func AddNotificationCron(s *discordgo.Session) {
	c := cron.New()
	addNotificationCronWeekly(c, s, "0 19 * * 3", "874324504401301564", "stirner", "874508087598383154")
	...
	addNotificationCronWeekly(c, s, "30 15 * * 6", "869272998576787516", "existentialism", "869240946301235252")
	...
	addNotificationCronWeekly(c, s, "30 19 * * 0", "903601581302362205", "meaning-of-life", "903668792771620864")
	c.Start()
}
